...
def _prep_testing_database(options, file_config):
    ...
    if options.dropfirst:
        ...
        for cfg in config.Config.all_configs():
            provision.drop_all_schema_objects(cfg, cfg.dba)
        ...
        for cfg in reversed(
            sorted(
                ...
                key=lambda cfg: (
                    cfg.dba.name,
                    cfg.dba.driver,
                    cfg.dba.dialect.server_version_info,
                ),
            )
        ):
            db = cfg.dba.name
        ...
        msg = "'%s' unsupported on any DB implementation %s%s" % (
            ...
            ", ".join(
                ...
                % (
                    ...
                    ".".join(
                        str(dig)
                        for dig in exclusions._server_version(config_obj.dba)
                    ),
                    config_obj.dba.driver,
                )
