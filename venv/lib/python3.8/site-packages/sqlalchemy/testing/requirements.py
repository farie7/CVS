...
class SuiteRequirements(Requirements):
    ...
    def queue_pool(self):
        ...
        def go(config):
            return isinstance(config.dba.pool, QueuePool)
    ...
    def sane_rowcount(self):
        return exclusions.skip_if(
            lambda config: not config.dba.dialect.supports_sane_rowcount,
    ...
    def sane_multi_rowcount(self):
        return exclusions.fails_if(
            lambda config: not config.dba.dialect.supports_sane_multi_rowcount,
    ...
    def sane_rowcount_w_returning(self):
        return exclusions.fails_if(
            lambda config: not (
                config.dba.dialect.supports_sane_rowcount_returning
            ),
    ...
    def empty_inserts(self):
        ...
        return exclusions.only_if(
            lambda config: config.dba.dialect.supports_empty_insert
            or config.dba.dialect.supports_default_values
            or config.dba.dialect.supports_default_metavalue,
    ...
    def full_returning(self):
        ...
        return exclusions.only_if(
            lambda config: config.dba.dialect.full_returning,
    ...
    def insert_executemany_returning(self):
        ...
        return exclusions.only_if(
            lambda config: config.dba.dialect.insert_executemany_returning,
    ...
    def returning(self):
        ...
        return exclusions.only_if(
            lambda config: config.dba.dialect.implicit_returning,
    ...
    def denormalized_names(self):
        ...
        return exclusions.skip_if(
            lambda config: not config.dba.dialect.requires_name_normalize,
    ...
    def multivalues_inserts(self):
        ...
        return exclusions.skip_if(
            lambda config: not config.dba.dialect.supports_multivalues_insert,
    ...
    def schemas(self):
        ...
        return only_on(lambda config: config.dba.dialect.supports_schemas)
    ...
    def server_side_cursors(self):
        ...
        return exclusions.only_if(
            [lambda config: config.dba.dialect.supports_server_side_cursors],
    ...
    def sequences(self):
        ...
        return exclusions.only_if(
            [lambda config: config.dba.dialect.supports_sequences],
            "no sequence support",
        )
    ...
    def sequences_optional(self):
        ...
        return exclusions.only_if(
            [
                lambda config: config.dba.dialect.supports_sequences
                and config.dba.dialect.sequences_optional
            ],
    ...
    def supports_lastrowid(self):
        ...
        """
        return exclusions.only_if(
            [lambda config: config.dba.dialect.postfetch_lastrowid]
        )
    ...
    def no_lastrowid_support(self):
        ...
        return exclusions.only_if(
            [lambda config: not config.dba.dialect.postfetch_lastrowid]
        )
    ...
    def supports_is_distinct_from(self):
        ...
        """
        return exclusions.skip_if(
            lambda config: not config.dba.dialect.supports_is_distinct_from,
